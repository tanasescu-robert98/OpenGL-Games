...
void SimpleScene::InitResources()
{
	...
	//	shader->AddShader(RESOURCE_PATH::SHADERS + "MVP.Texture.VS.glsl", GL_VERTEX_SHADER);
	//	shader->AddShader(RESOURCE_PATH::SHADERS + "PlatformShader.FS.glsl", GL_FRAGMENT_SHADER);
	//	shader->CreateAndLink();
	//	shaders[shader->GetName()] = shader;
	//}
	...
	//// Create a shader program for drawing vertex colors
	//{
	//	Shader* shader = new Shader("HitPlatformShader");
	//	shader->AddShader(RESOURCE_PATH::SHADERS + "MVP.Texture.VS.glsl", GL_VERTEX_SHADER);
	//	shader->AddShader(RESOURCE_PATH::SHADERS + "HitPlatformShader.FS.glsl", GL_FRAGMENT_SHADER);
	//	shader->CreateAndLink();
	//	shaders[shader->GetName()] = shader;
	//}

	//{
	//	Shader* shader = new Shader("RedPlatform");
	//	shader->AddShader(RESOURCE_PATH::SHADERS + "MVP.Texture.VS.glsl", GL_VERTEX_SHADER);
	//	shader->AddShader(RESOURCE_PATH::SHADERS + "RedPlatform.FS.glsl", GL_FRAGMENT_SHADER);
	//	shader->CreateAndLink();
	//	shaders[shader->GetName()] = shader;
	//}

	//{
	//	Shader* shader = new Shader("YellowPlatform");
	//	shader->AddShader(RESOURCE_PATH::SHADERS + "MVP.Texture.VS.glsl", GL_VERTEX_SHADER);
	//	shader->AddShader(RESOURCE_PATH::SHADERS + "YellowPlatform.FS.glsl", GL_FRAGMENT_SHADER);
	//	shader->CreateAndLink();
	//	shaders[shader->GetName()] = shader;
	//}

	//{
	//	Shader* shader = new Shader("GreenPlatform");
	//	shader->AddShader(RESOURCE_PATH::SHADERS + "MVP.Texture.VS.glsl", GL_VERTEX_SHADER);
	//	shader->AddShader(RESOURCE_PATH::SHADERS + "GreenPlatform.FS.glsl", GL_FRAGMENT_SHADER);
	//	shader->CreateAndLink();
	//	shaders[shader->GetName()] = shader;
	//}

	//{
	//	Shader* shader = new Shader("MovPlatform");
	//	shader->AddShader(RESOURCE_PATH::SHADERS + "MVP.Texture.VS.glsl", GL_VERTEX_SHADER);
	//	shader->AddShader(RESOURCE_PATH::SHADERS + "MovPlatform.FS.glsl", GL_FRAGMENT_SHADER);
	//	shader->CreateAndLink();
	//	shaders[shader->GetName()] = shader;
	//}
	...
	//{
	//	Shader* shader = new Shader("Ceva");
	//	shader->AddShader(RESOURCE_PATH::SHADERS + "Ceva.VS.glsl", GL_VERTEX_SHADER);
	//	shader->AddShader(RESOURCE_PATH::SHADERS + "Ceva.FS.glsl", GL_FRAGMENT_SHADER);
	//	shader->CreateAndLink();
	//	shaders[shader->GetName()] = shader;
	//}
